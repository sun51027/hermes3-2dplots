...
python3 make_plot.py -i 260427_reproduce_1e21_neumann_nowallpump 260417_reproduce_1e20_neumann_NV -o 260428_reproduce1e20_1e21_compare -r omp -p outer_lower -m benchmark multifiles
